...
use libcec_sys::{
    cec_audio_status, cec_command, cec_command, cec_datapacket, cec_datapacket,
    cec_device_type_list, cec_device_type_list, cec_keypress, cec_keypress, cec_log_message,
    cec_log_message, cec_logical_address, cec_logical_address, cec_logical_addresses,
    cec_logical_addresses, cec_power_status, cec_power_status, libcec_audio_get_status,
    libcec_audio_get_status, libcec_audio_mute, libcec_audio_mute, libcec_audio_toggle_mute,
    libcec_audio_toggle_mute, libcec_audio_unmute, libcec_audio_unmute, libcec_clear_configuration,
    libcec_clear_configuration, libcec_configuration, libcec_configuration, libcec_connection_t,
    libcec_connection_t, libcec_destroy, libcec_destroy, libcec_get_active_source,
    libcec_get_active_source, libcec_get_device_power_status, libcec_get_device_power_status,
    libcec_get_logical_addresses, libcec_get_logical_addresses, libcec_initialise,
    libcec_initialise, libcec_is_active_source, libcec_is_active_source, libcec_mute_audio,
    libcec_mute_audio, libcec_open, libcec_open, libcec_power_on_devices, libcec_power_on_devices,
    libcec_send_key_release, libcec_send_key_release, libcec_send_keypress, libcec_send_keypress,
    libcec_set_active_source, libcec_set_active_source, libcec_set_inactive_view,
    libcec_set_inactive_view, libcec_set_logical_address, libcec_set_logical_address,
    libcec_standby_devices, libcec_standby_devices, libcec_switch_monitoring,
    libcec_switch_monitoring, libcec_transmit, libcec_transmit, libcec_volume_down,
    libcec_volume_down, libcec_volume_up, libcec_volume_up, ICECCallbacks, ICECCallbacks,
    LIBCEC_OSD_NAME_SIZE, LIBCEC_OSD_NAME_SIZE, LIBCEC_VERSION_CURRENT, LIBCEC_VERSION_CURRENT,
};
